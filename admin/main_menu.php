  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      ...
      <tr class="bggray">
        ...
        <td align="center" valign="middle" class="borderbottom"><a href="add.php" target="mainFrame" onFocus="this.blur()" class="add">修改</a><span class="gray">&nbsp;|&nbsp;</span><a href="add.php" target="mainFrame" onFocus="this.blur()" class="add">复制</a><span class="gray">&nbsp;|&nbsp;</span><a href="add.php" target="mainFrame" onFocus="this.blur()" class="add">删除</a></td>
      </tr>
      <tr class="bggray">
        <td align="center" valign="middle" class="borderright borderbottom"><input type="text" name="" class="text-word" value="112"></td>
        <td align="left" valign="middle" class="borderright borderbottom tdb"><img src="images/main/dirfirst.gif" width="15" height="13"></td>
