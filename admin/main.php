...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="main">
  <tr>
    ...
    <span class="time"><strong>上午好！<?php echo $_COOKIE['name']; ?></strong><u>[管理员]</u></span>
    <div class="top"><span class="left">您上次的登灵时间：<?php echo date('Y-m-d H:i:s', $_COOKIE['lastTime']); ?>   登录IP：127.0.0.1 &nbsp;&nbsp;&nbsp;&nbsp;如非您本人操作，请及时</span><a href="index.php" target="mainFrame" onFocus="this.blur()">更改密码</a></div>
    <div class="sec">这是您第<span class="num"><?php echo $_COOKIE['count']; ?></span>次,登录！</div>
    </td>
  </tr>
  <tr>
...
程序编码：UTF-8<br/>
    ...
    <div class="main-con">
服务器软件：<?php print_r($_SERVER['SERVER_SOFTWARE']); ?><br/>
PHP版本：7.0.9<br/>
MYSQL版本： 10.1.16-MariaDB<br/>
魔术引用：开启 (建议开启)<br/>
