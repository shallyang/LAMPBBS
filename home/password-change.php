...
<html>
	...
	<!-- 网页主体头部设计 -->
		...
		<div id="content">
			...
			<div id="guide">
				<p><a href="index.php" target="_blank" class="achange" >LAMP兄弟连</a> &gt; <a href="#" target="_blank" class="achange" >个人中心</a></p>
			</div>
			<div id="chagemain">
				<div id="changelist">
				...
				<div id="changeitem">
					<form method="post" id="formad" action="doPwd.php?id=<?php echo $id; ?>">
						原密码 : <input type="password" name="oldpwd" value="" id="username" /><br/><br/>
						新密码 : <input type="password" name="newpwd" value="" id="useremail" /><br/><br/>
						确认密码 : <input type="password" name="repwd" value="" id="userqq" /><br/><br/>
