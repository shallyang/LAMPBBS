					...
					<div style="background-color:#ffffff;height:100px">
						...
						<!-- <板块名> -->
							...
							<div>
								...
								<span>
									<p  id="inputtime">基础编程、疑难解答、学习和开发过程的经验总结等。</p>
								</span>
							</div>
						</div>
					</div>
					...
					<div style="background-color:#FFFFFF">
						<table>
							...
							<tr style="border-bottom:1px dotted #000;">
								...
								<td width="450px" class="valigncenter"><a href="reply-logined.php?id=<?php echo $id; ?>&postid=<?php echo $postId; ?>&plateid=<?php echo $plateId;?>"><?php echo $postTitle; ?></a></td>
                                <?php
							...
							<tr>
								<td colspan="5" class="valigncenter">
									...
									<a href="new-post.php?id=<?php echo $id;?>&plateid=<?php echo $plateId; ?>"><button class="newmessage">发帖</button></a>
								</td>
							</tr>
						</table>
					</div>
