...
<html>
	<head>
		...
		<link href="css/photochange.css" rel="stylesheet" type="text/css"/>
	</head>
	<body>
	<!-- 网页主体头部设计 -->
		<div id="head">
		...
		<div id="content">
			...
			<div id="chagemain">
                ...
                <?php
                    ...
                    //获取图片文件名
                    $imgName = mysqli_fetch_assoc($res)['photo'];
                ?>
					<form id="formad" method="post" enctype="multipart/form-data" action="doHeadChange.php?id=<?php echo $id; ?>">
						<div id="oldphoto">原头像 : </div><img src="../public/home/headimgs/<?php echo $imgName;?>" width="100px" height="100px" /><br/><br/>
						新头像 : <input type="file" name="newphoto" value="" /><br/><br/>
